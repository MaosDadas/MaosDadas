...
class _Login1WidgetState extends State<Login1Widget> {
  ...
  void initState() {
    ...
    _model.datadenacimentoController ??= TextEditingController();
    _model.telefoneController ??= TextEditingController();
    _model.emailcadController ??= TextEditingController();
    _model.senhacadController ??= TextEditingController();
                                      ...
                                      children: [
                                        Expanded(
                                          child: TextFormField(
                                            ...
                                            validator: _model
                                                .datadenacimentoControllerValidator
                                                .asValidator(context),
                                            inputFormatters: [
                                              _model.datadenacimentoMask
                                            ],
                                          ),
                                        ),
                                      ],
